...
-- ----------------------------
-- Table structure for airplayauth_auth_config
-- ----------------------------
DROP TABLE IF EXISTS `airplayauth_auth_config`;
CREATE TABLE `airplayauth_auth_config` (
  `SEQUENCE_NBR` bigint(20) NOT NULL COMMENT '物理主键',
  `MACHINE_MODEL` varchar(255) NOT NULL COMMENT '机型',
  `COMPANY_NAME` varchar(255) NOT NULL COMMENT '公司名称',
  `COMPANY_CODE` varchar(255) NOT NULL COMMENT '公司编码',
  `PRIVATE_KEY` varchar(255) NOT NULL COMMENT '授权密钥',
  `MAX_AUTH_COUNT` int(11) NOT NULL COMMENT '最大授权数',
  ...
  `DESCRIPTION` varchar(255) DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`SEQUENCE_NBR`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='授权配置表';

-- ----------------------------
-- Records of airplayauth_auth_config
-- ----------------------------
INSERT INTO `airplayauth_auth_config` VALUES ('1100304659744100352', 'windows95', '公司A', 'GONGSIA', 'a123456', '2000', '2019-02-26 16:00:48', '2019-02-26 16:02:39', '9527', 'A', null, null, null, null);
INSERT INTO `airplayauth_auth_config` VALUES ('1100305258141257728', 'windows95', '公司B', 'GONGSIB', 'asdasdasdas', '5000', '2019-02-26 16:03:11', '2019-02-26 16:08:28', '9527', 'A', null, null, null, null);

-- ----------------------------
-- Table structure for airplayauth_auth_history
-- ----------------------------
DROP TABLE IF EXISTS `airplayauth_auth_history`;
CREATE TABLE `airplayauth_auth_history` (
  `SEQUENCE_NBR` bigint(20) NOT NULL COMMENT '物理主键',
  `DEVICE_MAC` varchar(255) NOT NULL COMMENT '设备MAC地址',
  `MACHINE_MODEL_ID` bigint(20) DEFAULT NULL COMMENT '机型ID',
  `COMPANY_ID` bigint(20) DEFAULT NULL COMMENT '公司ID',
  `MACHINE_MODEL_NAME` varchar(255) DEFAULT NULL COMMENT '机型名称',
  `COMPANY_NAME` varchar(255) DEFAULT NULL COMMENT '公司名称',
  `COMPANY_CODE` varchar(255) DEFAULT NULL COMMENT '公司编码',
  `AUTH_TIME` datetime NOT NULL COMMENT '认证时间',
  `AUTH_SUCCESS` varchar(1) NOT NULL COMMENT '是否认证成功',
  `FAILED_MESSAGE` varchar(255) DEFAULT NULL COMMENT '认证失败信息',
  `REC_DATE` datetime NOT NULL COMMENT '创建时间',
  `REC_USER_ID` varchar(32) NOT NULL COMMENT '创建者',
  `REC_STATUS` varchar(1) NOT NULL DEFAULT 'A' COMMENT '数据状态 :I 非激活 /A  激活',
  `EXTEND1` varchar(32) DEFAULT NULL COMMENT '扩展字段1',
  ...
  `DESCRIPTION` varchar(255) DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`SEQUENCE_NBR`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='设备认证记录表';

-- ----------------------------
-- Records of airplayauth_auth_history
-- ----------------------------

-- ----------------------------
-- Table structure for airplayauth_auth_info
-- ----------------------------
DROP TABLE IF EXISTS `airplayauth_auth_info`;
CREATE TABLE `airplayauth_auth_info` (
  `SEQUENCE_NBR` bigint(20) NOT NULL COMMENT '物理主键',
  `COMPANY_CODE` varchar(255) NOT NULL COMMENT '公司编码',
  `MACHINE_MODEL` varchar(255) NOT NULL COMMENT '机型',
  `DEVICE_MAC` varchar(255) NOT NULL COMMENT '设备MAC地址',
  `AUTH_CODE` varchar(16) NOT NULL COMMENT '授权码',
  `REC_DATE` datetime NOT NULL COMMENT '创建时间',
  `REC_USER_ID` varchar(32) NOT NULL COMMENT '创建者',
  `REC_STATUS` varchar(1) NOT NULL DEFAULT 'A' COMMENT '数据状态 :I 非激活 /A  激活',
  `EXTEND1` varchar(32) DEFAULT NULL COMMENT '扩展字段1',
...
-- ----------------------------
-- Records of airplayauth_auth_info
-- ----------------------------
INSERT INTO `airplayauth_auth_info` VALUES ('1100338129425940480', 'GONGSIA', 'windows95', '12-de-23-08-ef-46', '005B', '2019-02-26 18:13:48', '0', 'A', null, null, null, null);

-- ----------------------------
-- Table structure for airplayauth_company
-- ----------------------------
DROP TABLE IF EXISTS `airplayauth_company`;
CREATE TABLE `airplayauth_company` (
  `SEQUENCE_NBR` bigint(20) NOT NULL COMMENT '物理主键',
  `NAME` varchar(255) NOT NULL COMMENT '公司名称',
  `CODE` varchar(255) NOT NULL COMMENT '公司编码',
  `REC_DATE` datetime NOT NULL COMMENT '创建时间',
  `REC_USER_ID` varchar(32) NOT NULL COMMENT '创建者',
  `REC_STATUS` varchar(1) NOT NULL DEFAULT 'A' COMMENT '数据状态 :I 非激活 /A  激活',
  `EXTEND1` varchar(32) DEFAULT NULL COMMENT '扩展字段1',
...
-- ----------------------------
-- Records of airplayauth_company
-- ----------------------------
...
INSERT INTO `security_login_history` VALUES ('1100204803574833152', '0c231c0b-4c54-4c48-92c6-1670a1a6e5ca', 'SUPER_ADMIN', '1100204803214123008', '匿名用户', 'ANONYMOUS1100204803214123009', '0', 'Manage', '192.168.2.253', '2592000', 'N', '2019-02-26 09:24:01', 'request', '2019-02-26 09:24:01', 'A', '1100204803214123008');
INSERT INTO `security_login_history` VALUES ('1100204804476608513', 'd7c203cf-c941-458c-97ed-f61d84658388', 'SUPER_ADMIN', '9527', '管理员', 'super', '300', 'Manage', '192.168.2.253', '2592000', 'N', '2019-02-26 09:24:01', 'Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/72.0.3626.109 Safari/537.36', '2019-02-26 09:24:01', 'A', '9527');
INSERT INTO `security_login_history` VALUES ('1100205097805258752', 'e343d3a6-41a4-414d-a4b6-deafcf2223d4', 'SUPER_ADMIN', '1100205097771704320', '匿名用户', 'ANONYMOUS1100205097771704321', '0', 'Manage', '192.168.2.253', '2592000', 'N', '2019-02-26 09:25:11', 'request', '2019-02-26 09:25:11', 'A', '1100205097771704320');
INSERT INTO `security_login_history` VALUES ('1100205098010779648', 'fd120e81-d52e-4722-a739-565fd785b848', 'SUPER_ADMIN', '9527', '管理员', 'super', '300', 'Manage', '192.168.2.253', '2592000', 'N', '2019-02-26 09:25:11', 'Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/72.0.3626.109 Safari/537.36', '2019-02-26 09:25:11', 'A', '9527');
INSERT INTO `security_login_history` VALUES ('1100207897633202176', '2b44a73c-b5f0-479a-aaae-02dcf9ff66de', 'SUPER_ADMIN', '1100207897587064832', '匿名用户', 'ANONYMOUS1100207897587064833', '0', 'Manage', '192.168.2.253', '2592000', 'N', '2019-02-26 09:36:18', 'request', '2019-02-26 09:36:18', 'A', '1100207897587064832');
INSERT INTO `security_login_history` VALUES ('1100207897834528769', '59bc029b-0b4e-4416-bf56-1d6ea1b64c87', 'SUPER_ADMIN', '9527', '管理员', 'super', '300', 'Manage', '192.168.2.253', '2592000', 'N', '2019-02-26 09:36:18', 'Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/72.0.3626.109 Safari/537.36', '2019-02-26 09:36:18', 'A', '9527');
...
INSERT INTO `security_module` VALUES ('1100208180945854464', 'SUPER_ADMIN', 'menu', 'airplayAuthManage', '设备授权管理', 'root', 'module', '', '2', '1', 'Y', '2019-02-26 09:44:42', '9527', 'A', 'N', '2019-02-26 09:37:26', '9527', null, null, null, null);
INSERT INTO `security_module` VALUES ('1100208725899190272', 'SUPER_ADMIN', 'menu', 'airplayAuthBaseInfo', '基础信息', 'airplayAuthManage', 'module', '', '1', '2', 'Y', '2019-02-26 09:39:36', '9527', 'A', 'N', '2019-02-26 09:39:36', '9527', null, null, null, null);
INSERT INTO `security_module` VALUES ('1100209055542124544', 'SUPER_ADMIN', 'menu', 'airplayAuthInfo', '授权信息', 'airplayAuthManage', 'module', '', '2', '2', 'Y', '2019-02-26 09:40:54', '9527', 'A', 'N', '2019-02-26 09:40:54', '9527', null, null, null, null);
INSERT INTO `security_module` VALUES ('1100209237516197888', 'SUPER_ADMIN', 'menu', 'airplayAuthDevice', '设备管理', 'airplayAuthBaseInfo', 'button', 'airplayauth/device', '1', '3', 'Y', '2019-02-26 09:41:38', '9527', 'A', 'N', '2019-02-26 09:41:38', '9527', null, null, null, null);
INSERT INTO `security_module` VALUES ('1100209375647211520', 'SUPER_ADMIN', 'menu', 'airplayAuthCompany', '公司管理', 'airplayAuthBaseInfo', 'button', 'airplayauth/company', '2', '3', 'Y', '2019-02-26 09:42:11', '9527', 'A', 'N', '2019-02-26 09:42:11', '9527', null, null, null, null);
INSERT INTO `security_module` VALUES ('1100209737712115712', 'SUPER_ADMIN', 'menu', 'deviceAuthManage', '设备授权', 'airplayAuthInfo', 'button', 'airplayauth/auth', '2', '3', 'Y', '2019-02-26 09:43:37', '9527', 'A', 'N', '2019-02-26 09:43:37', '9527', null, null, null, null);
INSERT INTO `security_module` VALUES ('1100209929693798400', 'SUPER_ADMIN', 'menu', 'deviceAuthHistory', '设备认证记录', 'airplayAuthInfo', 'button', 'airplayauth/history', '2', '3', 'Y', '2019-02-26 09:44:23', '9527', 'A', 'N', '2019-02-26 09:44:23', '9527', null, null, null, null);
...
-- ----------------------------
INSERT INTO `security_module_primary` VALUES ('1100211639506018304', 'role', 'ADMIN', 'SUPER_ADMIN', 'dictionary', '2019-02-26 09:51:10', '9527', 'Y', null, null, null, null);
INSERT INTO `security_module_primary` VALUES ('1100211639510212608', 'role', 'ADMIN', 'SUPER_ADMIN', 'system', '2019-02-26 09:51:10', '9527', 'Y', null, null, null, null);
INSERT INTO `security_module_primary` VALUES ('1100211639514406912', 'role', 'ADMIN', 'SUPER_ADMIN', 'role', '2019-02-26 09:51:10', '9527', 'Y', null, null, null, null);
INSERT INTO `security_module_primary` VALUES ('1100211639514406913', 'role', 'ADMIN', 'SUPER_ADMIN', 'privilegeMg', '2019-02-26 09:51:10', '9527', 'Y', null, null, null, null);
INSERT INTO `security_module_primary` VALUES ('1100211639514406914', 'role', 'ADMIN', 'SUPER_ADMIN', 'organization', '2019-02-26 09:51:10', '9527', 'Y', null, null, null, null);
INSERT INTO `security_module_primary` VALUES ('1100211639514406915', 'role', 'ADMIN', 'SUPER_ADMIN', 'column', '2019-02-26 09:51:10', '9527', 'Y', null, null, null, null);
INSERT INTO `security_module_primary` VALUES ('1100211639514406916', 'role', 'ADMIN', 'SUPER_ADMIN', 'privilege', '2019-02-26 09:51:10', '9527', 'Y', null, null, null, null);
INSERT INTO `security_module_primary` VALUES ('1100211639514406917', 'role', 'ADMIN', 'SUPER_ADMIN', 'dept', '2019-02-26 09:51:10', '9527', 'Y', null, null, null, null);
INSERT INTO `security_module_primary` VALUES ('1100211639514406918', 'role', 'ADMIN', 'SUPER_ADMIN', 'backStage', '2019-02-26 09:51:10', '9527', 'Y', null, null, null, null);
INSERT INTO `security_module_primary` VALUES ('1100211639514406919', 'role', 'ADMIN', 'SUPER_ADMIN', 'sysmoudle', '2019-02-26 09:51:10', '9527', 'Y', null, null, null, null);
INSERT INTO `security_module_primary` VALUES ('1100211639514406920', 'role', 'ADMIN', 'SUPER_ADMIN', 'user', '2019-02-26 09:51:10', '9527', 'Y', null, null, null, null);
INSERT INTO `security_module_primary` VALUES ('1100211639514406921', 'role', 'ADMIN', 'SUPER_ADMIN', 'group', '2019-02-26 09:51:10', '9527', 'Y', null, null, null, null);
...
-- ----------------------------
INSERT INTO `security_operation` VALUES ('1099922199554310144', 'authresourcesv1', '系统用户认证', 'API', 'authAnonymous', '匿名用户登录', 'ALL', '/1/authentication/anonymous', 'POST', 'CB64F1E65C990355966E53D284AF5EC5', 'Y', '2019-02-26 09:14:04', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1099922199592058880', 'authresourcesv1', '系统用户认证', 'API', 'authSuperAdmin', '超级管理员登录。', 'SUPERADMIN', '/1/authentication/superadmin', 'POST', 'AE7B7DFC22F89671D547A4EDB411FAD1', 'Y', '2019-02-26 09:14:04', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1099922199613030400', 'employeeresourcev1', '员工管理', 'API', 'createEmployee', '新增员工信息', 'AGENCY', '/1/employees', 'POST', '0A6072BB9ED2491D5D9BD417A968D870', 'N', '2019-02-26 09:14:04', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1099922199638196224', 'employeeresourcev1', '员工管理', 'API', 'isEmployeeCodeUnique', '验证工号是否可用', 'AGENCY', '/1/employees/available', 'GET', '48B82F07EB2CF12DBDDAD769A76921AD', 'N', '2019-02-26 09:14:04', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1099922199734665216', 'employeeresourcev1', '员工管理', 'API', 'getEmployeeForPage', '获取员工简要信息', 'SUPERADMIN', '/1/employees/brieflyEmployee', 'GET', '43688187C7E60442D26C67DC9E309B6A', 'N', '2019-02-26 09:14:04', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1099922199755636736', 'employeeresourcev1', '员工管理', 'API', 'getBrieflyEmployeeByParam', '获取员工简要信息(条件查询)', 'AGENCY', '/1/employees/brieflyEmployee/by/param', 'GET', '26BF8DCF35A010BF27CA63372C320F0C', 'N', '2019-02-26 09:14:04', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1099922199780802560', 'employeeresourcev1', '员工管理', 'API', 'getEmployeeForPage', '分页获取员工信息', 'AGENCY', '/1/employees/page', 'GET', '97395F2B960B1920E3FB8C5564811470', 'N', '2019-02-26 09:14:04', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1099922199805968384', 'employeeresourcev1', '员工管理', 'API', 'updateEmployeePassword', '重置员工密码', 'SUPERADMIN', '/1/employees/reset/{userId}', 'PUT', 'FE62E3FE57D206D17105991C692ED527', 'N', '2019-02-26 09:14:04', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1099922199864688640', 'employeeresourcev1', '员工管理', 'API', 'getEmployeeDetail', '获取员工信息详情', 'AGENCY', '/1/employees/{id}', 'GET', 'AFFA5B90EFAABCEB620D138008C664D7', 'N', '2019-02-26 09:14:04', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1099922199885660160', 'employeeresourcev1', '员工管理', 'API', 'updateEmployee', '编辑员工信息', 'AGENCY', '/1/employees/{userId}', 'PUT', '81E3703E5BAB8FB9BF0197BECAC0DBD9', 'N', '2019-02-26 09:14:04', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1099922199919214592', 'employeeresourcev1', '员工管理', 'API', 'updateLockStatus', '启用/禁用员工', 'AGENCY', '/1/employees/{userId}/lockStatus', 'PUT', '779770C2413FBFA27E29107117137545', 'N', '2019-02-26 09:14:04', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1099922199940186112', 'moduleresourcesv1', '业务模块管理', 'API', 'createModule', '创建模块', 'SUPERADMIN', '/1/modules', 'POST', '85E0ABE745983B20BEB170660032D68A', 'N', '2019-02-26 09:14:04', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1099922199965351936', 'moduleresourcesv1', '业务模块管理', 'API', 'createAgencyModuleOperation', '给商家端分配模块操作', 'SUPERADMIN', '/1/modules/agencyModuleOperation', 'POST', '1694805F4771CD2A91602D885BFA557D', 'N', '2019-02-26 09:14:04', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1099922199986323456', 'moduleresourcesv1', '业务模块管理', 'API', 'getAgencyTemplateModuleTree', '获取商家模板业务模块树', 'AGENCY', '/1/modules/agencyTemplate/tree', 'GET', 'E5BC800B9EC20E54F00B1F414910E692', 'N', '2019-02-26 09:14:04', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1099922200011489280', 'moduleresourcesv1', '业务模块管理', 'API', 'getAllChildrenModule', '根据父业务模块编码获取子业务模块', 'SUPERADMIN', '/1/modules/children', 'GET', '607D93266CB265C3383043BF7962B2D2', 'N', '2019-02-26 09:14:04', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1099922200032460800', 'moduleresourcesv1', '业务模块管理', 'API', 'isModuleCodeAvailable', '判断模块code是否唯一', 'SUPERADMIN', '/1/modules/moduleCode/available', 'GET', '839AECDB4845FD7A38E186CCB89745D3', 'N', '2019-02-26 09:14:04', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1099922200057626624', 'moduleresourcesv1', '业务模块管理', 'API', 'createModuleOperation', '创建模块按钮', 'SUPERADMIN', '/1/modules/moduleOperation', 'POST', 'E1CF79871BD87D5001634F534F1AA675', 'N', '2019-02-26 09:14:04', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1099922200078598144', 'moduleresourcesv1', '业务模块管理', 'API', 'isOperationButtonCodeAvailable', '判断模块关联的按钮编码是否唯一', 'SUPERADMIN', '/1/modules/moduleOperation/buttonCode/available', 'GET', '4848611CDE18F91E89CF2473EA17AB5D', 'N', '2019-02-26 09:14:04', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1099922200103763968', 'moduleresourcesv1', '业务模块管理', 'API', 'getModuleButtonsByPage', '分页查询模块按钮', 'SUPERADMIN', '/1/modules/moduleOperation/page', 'GET', 'C64AD1CFB543034A4A10BB0DD2528C5B', 'N', '2019-02-26 09:14:04', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1099922200128929792', 'moduleresourcesv1', '业务模块管理', 'API', 'updateModuleOperation', '修改模块按钮', 'SUPERADMIN', '/1/modules/moduleOperation/{moduleOperationId}', 'PUT', 'D7C96908BB620EFAC8F241CD155CF5C6', 'N', '2019-02-26 09:14:04', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1099922200149901312', 'moduleresourcesv1', '业务模块管理', 'API', 'deleteModuleOperation', '删除模块按钮', 'SUPERADMIN', '/1/modules/moduleOperation/{moduleOperationId}', 'DELETE', '29B917ED3D568E7E053B51C5E86DC344', 'N', '2019-02-26 09:14:04', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1099922200170872832', 'moduleresourcesv1', '业务模块管理', 'API', 'deleteModule', '删除模块', 'SUPERADMIN', '/1/modules/{agencyCode}', 'DELETE', 'AC2E121B259DF984AA9AC1EFC08457F9', 'N', '2019-02-26 09:14:04', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1099922200196038656', 'moduleresourcesv1', '业务模块管理', 'API', 'getModuleTree', '根据商家编码获取业务模块树', 'SUPERADMIN', '/1/modules/{agencyCode}/tree', 'GET', 'B0F06A9F0A0725794047DED930486C18', 'N', '2019-02-26 09:14:04', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1099922200217010176', 'moduleresourcesv1', '业务模块管理', 'API', 'getByModule', '根据模块编码获取模块详细信息', 'SUPERADMIN', '/1/modules/{agencyCode}/{moduleCode}', 'GET', 'F232C9C5616486F8B0C62A86275530F0', 'N', '2019-02-26 09:14:04', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1099922200237981696', 'moduleresourcesv1', '业务模块管理', 'API', 'updateModule', '更新模块信息', 'SUPERADMIN', '/1/modules/{agencyCode}/{moduleCode}', 'PUT', '7B201035E1B35F7701275D4F9DA42CB4', 'N', '2019-02-26 09:14:04', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1099922200263147520', 'operationresourcev1', '平台资源操作管理', 'API', 'getAllOperations', '获取系统所有资源操作', 'SUPERADMIN', '/1/operations', 'GET', 'DA4E658C1DAF29C8B5491178613841FE', 'N', '2019-02-26 09:14:04', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1099922200284119040', 'operationresourcev1', '平台资源操作管理', 'API', 'createResource', '创建单个的资源操作信息', 'SUPERADMIN', '/1/operations', 'POST', '6E2C5EB4636C7546828CE6986198BAAB', 'N', '2019-02-26 09:14:04', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1099922200309284864', 'operationresourcev1', '平台资源操作管理', 'API', 'deleteResources', '删除系统资源操作', 'SUPERADMIN', '/1/operations', 'DELETE', '396363F6B48DAAAEC48E1BBA0ACD222A', 'N', '2019-02-26 09:14:04', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1099922200330256384', 'operationresourcev1', '平台资源操作管理', 'API', 'isFuncIdAvailable', '判断资源FID否唯一', 'AGENCY', '/1/operations/funcId/available', 'GET', '6C57988FAD7514C88A9E0E7DEF67E452', 'N', '2019-02-26 09:14:04', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1099922200355422208', 'operationresourcev1', '平台资源操作管理', 'API', 'getForPage', '分页获取资源列表', 'AGENCY', '/1/operations/page', 'GET', '8B33278C2A3DA7A828C698C4CAFF1286', 'N', '2019-02-26 09:14:04', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1099922200376393728', 'operationresourcev1', '平台资源操作管理', 'API', 'updateOperation', '修改系统资源操作', 'SUPERADMIN', '/1/operations/{id}', 'PUT', 'FC85EBD33C5382BBB758404368CECE9F', 'N', '2019-02-26 09:14:04', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1099922200426725376', 'permissionresourcev1', '系统权限管理', 'API', 'createOrUpdatePermission', '创建主体权限信息', 'AGENCY', '/1/permissions', 'POST', '0AEE9F0F1E4B0244A52E3E5D844BF7A1', 'N', '2019-02-26 09:14:04', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1099922200451891200', 'permissionresourcev1', '系统权限管理', 'API', 'getSysPrivilegeTree', '获取当前商家所有模块按钮资源', 'AGENCY', '/1/permissions', 'GET', 'C8C2D8E88F93F0998A00C5FFD058E4F4', 'N', '2019-02-26 09:14:04', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1099922200472862720', 'permissionresourcev1', '系统权限管理', 'API', 'getCurrentUserModuleButtons', '获取当前登录用户所有模块的按钮信息', 'AGENCY', '/1/permissions/module/operations', 'GET', 'F69ACE03E3738B67A5CB6E3FAEFBDC42', 'N', '2019-02-26 09:14:04', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1099922200498028544', 'permissionresourcev1', '系统权限管理', 'API', 'getUserModuleTree', '获取用户模块树', 'AGENCY', '/1/permissions/userModuleTree', 'GET', 'C9D206073D1CF0E6ABE0FDDD12373426', 'N', '2019-02-26 09:14:04', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1099922200523194368', 'permissionresourcev1', '系统权限管理', 'API', 'getPrimaryPermissions', '获取权限主体模块资源树', 'AGENCY', '/1/permissions/{primaryType}/{primaryCode}', 'GET', '66BA60EE674D6A1FCED5593C42684CC5', 'N', '2019-02-26 09:14:04', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1099922200544165888', 'roleresourcev1', '角色管理', 'API', 'deleteRole', '刪除角色', 'AGENCY', '/1/roles', 'DELETE', 'D08575563CC781EDE2A537081F22A20D', 'N', '2019-02-26 09:14:04', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1099922200569331712', 'roleresourcev1', '角色管理', 'API', 'getRoles', '条件查询角色列表。', 'AGENCY', '/1/roles', 'GET', 'D9AFB10EAE9C860F9662B2B579F7D96F', 'N', '2019-02-26 09:14:04', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1099922200598691840', 'roleresourcev1', '角色管理', 'API', 'createRole', '创建系统角色。', 'AGENCY', '/1/roles', 'POST', 'D68AA7F2CC51161BD314B994E92FC297', 'N', '2019-02-26 09:14:04', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1099922200619663360', 'roleresourcev1', '角色管理', 'API', 'queryForPage', '分頁查询角色列表。', 'AGENCY', '/1/roles/page', 'GET', 'FD5FBCEDFA3E2E636180CEA5EC328603', 'N', '2019-02-26 09:14:04', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1099922200640634880', 'roleresourcev1', '角色管理', 'API', 'isRoleCodeAvailable', '检查角色编号是否可用。', 'AGENCY', '/1/roles/roleCode/available', 'GET', 'D5A7C18497EBF7541D858CE6E7E99C38', 'N', '2019-02-26 09:14:04', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1099922200661606400', 'roleresourcev1', '角色管理', 'API', 'isRoleNameAvailable', '检查角色名称是否可用。', 'AGENCY', '/1/roles/roleName/available', 'GET', '83D23D9755766C6E44304ADE518B3C67', 'N', '2019-02-26 09:14:04', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1099922200686772224', 'roleresourcev1', '角色管理', 'API', 'updateRole', '更新系统角色。', 'AGENCY', '/1/roles/{roleCode}', 'PUT', 'D135C69A74FDB8A958132350430FA5FC', 'N', '2019-02-26 09:14:04', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1099922200711938048', 'roleresourcev1', '角色管理', 'API', 'getRole', '通过Code查找角色。', 'AGENCY', '/1/roles/{roleCode}', 'GET', 'E2401D67E5D18FA239CC4E04831FFFBB', 'N', '2019-02-26 09:14:04', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1099922200732909568', 'roleresourcev1', '角色管理', 'API', 'updateLockStatus', '启用/禁用角色', 'AGENCY', '/1/roles/{roleCode}/lockStatus', 'PUT', 'DA065838AE775D9C36CC87FDAF526051', 'N', '2019-02-26 09:14:04', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1099923260734181376', 'departmentresourcev1', '部门信息管理', 'API', 'deleteDepartment', '删除部门。', 'AGENCY', '/1/departments', 'DELETE', 'CE447D3164181E021FD5EE4BD71C06D4', 'N', '2019-02-26 09:14:42', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1099923260776124416', 'departmentresourcev1', '部门信息管理', 'API', 'createDepartment', '创建部门信息。', 'AGENCY', '/1/departments', 'POST', '3F62EFB2DD20A1855E7FF8BA8FAC67CB', 'N', '2019-02-26 09:14:42', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1099923260801290240', 'departmentresourcev1', '部门信息管理', 'API', 'isDepartmentNameAvailable', '判断部门名称是否可用。', 'AGENCY', '/1/departments/departmentName/available', 'GET', '782E8837C01945F8132C00B4B4CB4F2D', 'N', '2019-02-26 09:14:42', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1099923260910342144', 'departmentresourcev1', '部门信息管理', 'API', 'getDepartments', '分页查询部门信息(列表结构)。', 'AGENCY', '/1/departments/page', 'GET', '3B08E11D93B2D514ED8F1AAA4B4CC28E', 'N', '2019-02-26 09:14:42', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1099923260935507968', 'departmentresourcev1', '部门信息管理', 'API', 'getDepartmentTree', '获取当前机构部门树。', 'AGENCY', '/1/departments/tree', 'GET', '9395419D19E94E7B07B0AABC2AB49CB5', 'N', '2019-02-26 09:14:42', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1099923260960673792', 'departmentresourcev1', '部门信息管理', 'API', 'getByEmployees', '根据一级部门获取员工信息', 'AGENCY', '/1/departments/withEmployee', 'GET', '5EF37113FB389842EBC8AD415C8C5B21', 'N', '2019-02-26 09:14:42', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1099923260985839616', 'departmentresourcev1', '部门信息管理', 'API', 'getDepartment', '根据code获取部门信息。', 'AGENCY', '/1/departments/{departmentCode}', 'GET', 'F8B11101AED6592020536B8E02799F05', 'N', '2019-02-26 09:14:42', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1099923261011005440', 'departmentresourcev1', '部门信息管理', 'API', 'updateDepartment', '更新部门信息。', 'AGENCY', '/1/departments/{departmentCode}', 'PUT', '3A92CA9D43BBF96829C2973541902EB6', 'N', '2019-02-26 09:14:42', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1099923261036171264', 'departmentresourcev1', '部门信息管理', 'API', 'getAllChildrenDepartments', '获取所有的子部门。', 'AGENCY', '/1/departments/{departmentCode}/children', 'GET', '9B118BE14192F00B977DD7AC2FB616B3', 'N', '2019-02-26 09:14:42', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1099923261103280128', 'departmentresourcev1', '部门信息管理', 'API', 'updatelockStatus', '修改锁定状态。', 'AGENCY', '/1/departments/{departmentCode}/lockstatus', 'PUT', '37147529CB2D4EA97FF4F24D61F8B9D2', 'N', '2019-02-26 09:14:42', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1099923535117266944', 'asicolumnresourcev1', '动态表单列定义管理', 'API', 'copyASIColumns', '将列定义模板复制到子分组中', 'AGENCY', '/1/asi/columns/custom/replication/{agencyCode}/{groupCode}', 'POST', 'CBDDCAC6058FC3A5BC7277236B7186C4', 'N', '2019-02-26 09:13:19', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1099923535146627072', 'asicolumnresourcev1', '动态表单列定义管理', 'API', 'getGroupColumns', '根据子分组获取列定义列表', 'AGENCY', '/1/asi/columns/custom/{agencyCode}/{groupCode}', 'GET', '4911AD58865118C8DE5378CEF58673C0', 'N', '2019-02-26 09:13:19', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1099923535175987200', 'asicolumnresourcev1', '动态表单列定义管理', 'API', 'upsertGroupColumn', '创建/更新子分组的自定义列', 'AGENCY', '/1/asi/columns/custom/{agencyCode}/{groupCode}', 'POST', '42C60C19A76980A75D2DD637E9DAAC79', 'N', '2019-02-26 09:13:19', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1099923535201153024', 'asicolumnresourcev1', '动态表单列定义管理', 'API', 'getGroupColumn', '获取自定义列详情', 'AGENCY', '/1/asi/columns/custom/{agencyCode}/{groupCode}/{columnCode}', 'GET', '90D8BC2A8A72E810EC3BAE375D6671A1', 'N', '2019-02-26 09:13:19', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1099923535259873280', 'asicolumnresourcev1', '动态表单列定义管理', 'API', 'deleteGroupColumn', '删除子分组的自定义列', 'AGENCY', '/1/asi/columns/custom/{agencyCode}/{groupCode}/{columnCode}', 'DELETE', 'C4EA9797FE804F19E6D5A579B7DE349D', 'N', '2019-02-26 09:13:19', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1099923535285039104', 'asicolumnresourcev1', '动态表单列定义管理', 'API', 'isGroupColumnCodeAvailable', '判断自定义列编码是否可用', 'AGENCY', '/1/asi/columns/custom/{agencyCode}/{groupCode}/{columnCode}/available', 'GET', 'C4B629321E0D8DE20EEE01AA0EB32F16', 'N', '2019-02-26 09:13:19', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1099923535326982144', 'asicolumnresourcev1', '动态表单列定义管理', 'API', 'getAllDataTypes', '获取所有定义的数据类型', 'SUPERADMIN', '/1/asi/columns/datatypes', 'GET', '2CE1526CE45753933EE465624ED73B9A', 'N', '2019-02-26 09:13:19', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1099923535352147968', 'asicolumnresourcev1', '动态表单列定义管理', 'API', 'createColumnTemplate', '创建列定义模板', 'SUPERADMIN', '/1/asi/columns/template/{agencyCode}', 'POST', '61F02821A115E9446F479541224AB760', 'N', '2019-02-26 09:13:20', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1099923535381508096', 'asicolumnresourcev1', '动态表单列定义管理', 'API', 'updateASIColulnMeta', '更新列定义模板', 'SUPERADMIN', '/1/asi/columns/template/{agencyCode}', 'PUT', '738B1AD2F05ABE9035F041F6C67B6B9D', 'N', '2019-02-26 09:13:20', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1099923535406673920', 'asicolumnresourcev1', '动态表单列定义管理', 'API', 'getASIColulnMetas', '分页获取列定义模板列表', 'SUPERADMIN', '/1/asi/columns/template/{agencyCode}/page', 'GET', '756BB483775A8E81BCA82BCED5781DAF', 'N', '2019-02-26 09:13:20', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1099923535440228352', 'asicolumnresourcev1', '动态表单列定义管理', 'API', 'deleteColumnTemplate', '删除列定义模板', 'SUPERADMIN', '/1/asi/columns/template/{agencyCode}/{columnCode}', 'DELETE', '47307CA6D21AD662D6601A2E2C8DCD57', 'N', '2019-02-26 09:13:20', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1099923535469588480', 'asicolumnresourcev1', '动态表单列定义管理', 'API', 'getColumnTemplate', '获取列定义模板详情', 'SUPERADMIN', '/1/asi/columns/template/{agencyCode}/{columnCode}', 'GET', '56E66E5D96CA5E5B960A6B6C255D8D65', 'N', '2019-02-26 09:13:20', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1099923535494754304', 'asicolumnresourcev1', '动态表单列定义管理', 'API', 'isColumnTemplateCodeAvailable', '判断模板列的编码是否可用', 'SUPERADMIN', '/1/asi/columns/template/{agencyCode}/{columnCode}/available', 'GET', '4572BCF6CCC000DEDE198B8C311DE05F', 'N', '2019-02-26 09:13:20', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1099923535515725824', 'asigroupresourcev1', '动态表单组管理', 'API', 'updateGroup', '更新组定义', 'AGENCY', '/1/asi/groups/{agencyCode}', 'PUT', 'F0539BCCE3F14A5ED5C4A19D5B0A8FF2', 'N', '2019-02-26 09:13:20', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1099923535540891648', 'asigroupresourcev1', '动态表单组管理', 'API', 'createGroup', '创建组定义', 'AGENCY', '/1/asi/groups/{agencyCode}', 'POST', '4E53C5E9B0AFA29F2F1DCAC40C776DBA', 'N', '2019-02-26 09:13:20', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1099923535566057472', 'asigroupresourcev1', '动态表单组管理', 'API', 'isGroupCodeAvailable', '判断分组编码是否可用', 'AGENCY', '/1/asi/groups/{agencyCode}/available', 'GET', '331809704A4F0A93A480C7F07393429B', 'N', '2019-02-26 09:13:20', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1099923535595417600', 'asigroupresourcev1', '动态表单组管理', 'API', 'getGroupList', '根据父分组编码获取分组列表', 'ALL', '/1/asi/groups/{agencyCode}/list', 'GET', 'C462841232C727C92C2BE976A124E691', 'N', '2019-02-26 09:13:20', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1099923535620583424', 'asigroupresourcev1', '动态表单组管理', 'API', 'syncGroupTree', '同步获取分组树', 'ALL', '/1/asi/groups/{agencyCode}/tree', 'GET', '4C37F640785A56701A72F3362D44637C', 'Y', '2019-02-26 09:13:20', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1099923535645749248', 'asigroupresourcev1', '动态表单组管理', 'API', 'getGroup', '获取组定义详情', 'AGENCY', '/1/asi/groups/{agencyCode}/{groupCode}', 'GET', '08866B01F7B243689B33BABE1819B04B', 'N', '2019-02-26 09:13:20', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1099923535675109376', 'asigroupresourcev1', '动态表单组管理', 'API', 'deleteGroup', '删除组定义', 'AGENCY', '/1/asi/groups/{agencyCode}/{groupCode}', 'DELETE', 'E9F3D981A90F5EC1270617E8F8CFF179', 'N', '2019-02-26 09:13:20', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1099923535700275200', 'asiresourcesv1', '动态表单', 'API', 'upsertASIBiz', '将具体的业务类型和动态表单关联', 'AGENCY', '/1/asi', 'PUT', 'AD46AFC565A9C19EED9664525B6AB745', 'N', '2019-02-26 09:13:20', '0', 'A', 'N', null, null, null, null, null, null);
...
INSERT INTO `security_operation` VALUES ('1099923535746412544', 'asiresourcesv1', '动态表单', 'API', 'updateASIForm', '更新表单类型数据', 'AGENCY', '/1/asi/{agencyCode}/{entityType}/{entityId}/form', 'PUT', 'D3DA691C6C0118E89A4C18E94BFACAA2', 'N', '2019-02-26 09:13:20', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1099923535771578368', 'asiresourcesv1', '动态表单', 'API', 'updateASITable', '更新表格类型数据', 'AGENCY', '/1/asi/{agencyCode}/{entityType}/{entityId}/table', 'PUT', '03A325871858C28E5D30F9E577C6ACAC', 'N', '2019-02-26 09:13:20', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1099923535792549888', 'asiresourcesv1', '动态表单', 'API', 'getASIMeta', '获取实体的元数据定义', 'ALL', '/1/asi/{agencyCode}/{groupCode}/{entityType}/meta', 'GET', '190B7E042A4683FDF0BD4FAFBD2F4114', 'N', '2019-02-26 09:13:20', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1099923535813521408', 'asiresourcesv1', '动态表单', 'API', 'getValues', '获取实体的动态表单数据(同步获取所有数据)', 'ALL', '/1/asi/{agencyCode}/{groupCode}/{entityType}/{entityId}/allvalues', 'GET', 'BCEC9F61131630B62EE44DFD5D18C76F', 'N', '2019-02-26 09:13:20', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1099923535838687232', 'asiresourcesv1', '动态表单', 'API', 'isValueAvailable', '判断值是否可用', 'ALL', '/1/asi/{agencyCode}/{groupCode}/{entityType}/{entityId}/available', 'GET', 'E5077AA2AD9BC2C3D5F7E5972C500478', 'N', '2019-02-26 09:13:20', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1099923535859658752', 'asiresourcesv1', '动态表单', 'API', 'getByPage', '分页获取数据', 'ALL', '/1/asi/{agencyCode}/{groupCode}/{entityType}/{entityId}/conditionPage', 'GET', '7A23C17ACC5910FA3D7F07A6270309A1', 'N', '2019-02-26 09:13:20', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1099923535889018880', 'asiresourcesv1', '动态表单', 'API', 'getByList', '获取数据信息', 'ALL', '/1/asi/{agencyCode}/{groupCode}/{entityType}/{entityId}/list', 'GET', '8B14BAD45DDD5A762B85BD7CC9BBB46C', 'N', '2019-02-26 09:13:20', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1099923535909990400', 'asiresourcesv1', '动态表单', 'API', 'getDataByPage', '分页获取表格数据', 'ALL', '/1/asi/{agencyCode}/{groupCode}/{entityType}/{entityId}/page', 'GET', 'CB86A69680F58D5DB8F81068BA0A3E53', 'N', '2019-02-26 09:13:20', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1099923535935156224', 'asiresourcesv1', '动态表单', 'API', 'getValuesForGroup', '获取某个具体的子分组的元数据和数据(异步根据子分组获取)', 'ALL', '/1/asi/{agencyCode}/{groupCode}/{entityType}/{entityId}/values', 'GET', '31CB3D746375AEA1A42B39BBE1DEC6B5', 'N', '2019-02-26 09:13:20', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1099923535960322048', 'asiresourcesv1', '动态表单', 'API', 'getDataById', '根据ID获取实体数据', 'ALL', '/1/asi/{agencyCode}/{groupCode}/{entityType}/{entityId}/{mongoId}', 'GET', '5D0D50C36BAAD5BD5B5C689B14964283', 'N', '2019-02-26 09:13:20', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1099923902311731200', 'dictionaryresourcev1', '字典信息', 'API', 'createDictionary', '创建字典', 'AGENCY', '/1/dictionary', 'POST', 'AFCA52A3C0DC85657DB8121864D39C1D', 'N', '2019-02-26 09:12:46', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1099923902353674240', 'dictionaryresourcev1', '字典信息', 'API', 'deleteDictionary', '删除字典', 'AGENCY', '/1/dictionary', 'DELETE', 'F0F18D60475E04F6AF4F5742F718EA5C', 'N', '2019-02-26 09:12:46', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1099923902383034368', 'dictionaryresourcev1', '字典信息', 'API', 'queryForPage', '分页查询字典信息', 'ALL', '/1/dictionary/page', 'GET', '1158CF800826DF2BB9D914B158B4C7FC', 'N', '2019-02-26 09:12:46', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1099923902404005888', 'dictionaryresourcev1', '字典信息', 'API', 'queryByCode', '通过字典编码获取字典', 'ALL', '/1/dictionary/{dictCode}', 'GET', '3CFD02A49570A8B46F468526397B352D', 'N', '2019-02-26 09:12:46', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1099923902429171712', 'dictionaryresourcev1', '字典信息', 'API', 'updateDictionary', '更新字典', 'AGENCY', '/1/dictionary/{dictCode}', 'PUT', '4DC8476C9174E31436B2603317C01371', 'N', '2019-02-26 09:12:46', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1099923902454337536', 'dictionaryresourcev1', '字典信息', 'API', 'isDictionaryCodeAvailable', '检查字典编号是否可用', 'ALL', '/1/dictionary/{dictCode}/available', 'GET', '595CE802FBF3745A1B0C0859B65B7029', 'N', '2019-02-26 09:12:46', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1099923902483697664', 'dictionaryresourcev1', '字典信息', 'API', 'deleteStandardChoicesValue', '删除字典值', 'AGENCY', '/1/dictionary/{dictCode}/entries', 'DELETE', '1F58C9E6201DAF0B217CD5B16DB9622C', 'N', '2019-02-26 09:12:46', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1099923902504669184', 'dictionaryresourcev1', '字典信息', 'API', 'queryList', '根据字典编码获取当前商家字典的所有值', 'ALL', '/1/dictionary/{dictCode}/entries', 'GET', '5CB624AE1703FF924D8DD7736DB556DC', 'N', '2019-02-26 09:12:46', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1099923902643081216', 'dictionaryresourcev1', '字典信息', 'API', 'queryForValuePage', '根据字典编码分页条件查询字典值', 'ALL', '/1/dictionary/{dictCode}/entries/page', 'GET', '98CAEF281B86161ACEAD5FD2FD50A807', 'N', '2019-02-26 09:12:46', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1099923902668247040', 'dictionaryresourcev1', '字典信息', 'API', 'createStandardChoicesValue', '创建字典值', 'AGENCY', '/1/dictionary/{dictCode}/entry', 'POST', 'D2A8BD59EB26A9AC0520D1626DA2B960', 'N', '2019-02-26 09:12:46', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1099923902697607168', 'dictionaryresourcev1', '字典信息', 'API', 'updateStandardChoicesValue', '更新字典值', 'AGENCY', '/1/dictionary/{dictCode}/entry/{entryKey}', 'PUT', 'B8475FC1047C674EF2D5A7A2A693DEE7', 'N', '2019-02-26 09:12:46', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1099923902722772992', 'dictionaryresourcev1', '字典信息', 'API', 'queryValue', '获取指定字典值', 'ALL', '/1/dictionary/{dictCode}/entry/{key}', 'GET', '9EA5005F07E123895E2C730A271DF69B', 'N', '2019-02-26 09:12:46', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1099923902743744512', 'dictionaryresourcev1', '字典信息', 'API', 'isEntryKeyAvailable', '字典值key是否可用', 'ALL', '/1/dictionary/{dictCode}/entry/{key}/available', 'GET', '53E8CF085840907142BEF219D15E3627', 'N', '2019-02-26 09:12:46', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1099923902781493248', 'dictionaryresourcev1', '字典信息', 'API', 'updateLockStatus', '启用/禁用字典值。', 'AGENCY', '/1/dictionary/{dictCode}/entry/{key}/lockStatus', 'PUT', '1721A18063F430C31225647E03F8666F', 'N', '2019-02-26 09:12:46', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1099923902802464768', 'locationinforesourcev1', '位置信息管理', 'API', 'getAllLocations', '同步获取所有位置信息(树形结构)', 'ALL', '/1/location/all', 'GET', '7BD496738336FAD1891771974C52179C', 'N', '2019-02-26 09:12:46', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1099923902823436288', 'locationinforesourcev1', '位置信息管理', 'API', 'getProvince', '获取所有省份列表', 'ALL', '/1/location/provinces', 'GET', '970BBA97CD016A836E9A26CDA575DD9C', 'N', '2019-02-26 09:12:46', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1099923902848602112', 'locationinforesourcev1', '位置信息管理', 'API', 'getRegionsByCity', '根据市获取县/区列表', 'ALL', '/1/location/{cityCode}/regions', 'GET', '9FAFE56942881EEB97625D28DD930DDD', 'N', '2019-02-26 09:12:46', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1099923902869573632', 'locationinforesourcev1', '位置信息管理', 'API', 'getByCode', '根据位置编码获取位置信息', 'ALL', '/1/location/{locationCode}', 'GET', '2F08E56D9400C6B2AD65592ED492234D', 'N', '2019-02-26 09:12:46', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1099923902890545152', 'locationinforesourcev1', '位置信息管理', 'API', 'getCitiesByProvince', '根据省份获取城市列表', 'ALL', '/1/location/{provinceCode}/cities', 'GET', '4D1FB3A65E4C37559A56DC126BC84608', 'N', '2019-02-26 09:12:46', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1100255551511633920', 'authconfigresourcesv1', '设备授权配置管理', 'API', 'createAuthConfig', '创建设备授权配置', 'SUPERADMIN', '/1/authConfig', 'POST', '865CC844F60D1B85C46C7B2E887944A2', 'N', '2019-02-26 18:12:57', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1100255551591325696', 'authconfigresourcesv1', '设备授权配置管理', 'API', 'deleteAuthConfig', '删除设备授权配置', 'SUPERADMIN', '/1/authConfig/{id}', 'DELETE', 'F0DFFEEF5F358AFA50E1F4DFB24000E1', 'N', '2019-02-26 18:12:57', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1100255551616491520', 'authconfigresourcesv1', '设备授权配置管理', 'API', 'getAuthConfigByPage', '后台分页获取设备授权配置信息', 'SUPERADMIN', '/1/authConfig/manage/page', 'GET', '622DEF2CBC3D542768DFB387934C0F83', 'N', '2019-02-26 18:12:57', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1100255551641657344', 'authconfigresourcesv1', '设备授权配置管理', 'API', 'getAuthConfigById', '后台根据ID查询$设备授权配置', 'SUPERADMIN', '/1/authConfig/{id}', 'GET', '3CB2D524830946ABF570F6AD2DA87238', 'N', '2019-02-26 18:12:57', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1100255551671017472', 'authconfigresourcesv1', '设备授权配置管理', 'API', 'updateAuthConfig', '修改设备授权配置', 'SUPERADMIN', '/1/authConfig/{id}', 'PUT', 'F7E5505CAB20E5A65CA23AB8812E5722', 'N', '2019-02-26 18:12:57', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1100255551700377600', 'authhistoryresourcesv1', '[AuthHistory]管理', 'API', 'deleteAuthHistory', '删除$[AuthHistory]', 'SUPERADMIN', '/1/authHistory', 'DELETE', '9F321941CD4DC6BD73EF83D79601119D', 'N', '2019-02-26 18:12:57', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1100255551725543424', 'authhistoryresourcesv1', '[AuthHistory]管理', 'API', 'createAuthHistory', '创建[AuthHistory]', 'SUPERADMIN', '/1/authHistory', 'POST', '40C5D6DC26DC6731171570F9FCE1B5D6', 'N', '2019-02-26 18:12:57', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1100255551817818112', 'authhistoryresourcesv1', '[AuthHistory]管理', 'API', 'getAuthHistoryByPage', '后台分页获取$[AuthHistory]信息', 'SUPERADMIN', '/1/authHistory/manage/page', 'GET', 'B429CE7AC47D158FC71021C4771FEE8A', 'N', '2019-02-26 18:12:57', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1100255551868149760', 'authhistoryresourcesv1', '[AuthHistory]管理', 'API', 'getAuthHistoryById', '后台根据ID查询$[AuthHistory]', 'SUPERADMIN', '/1/authHistory/manage/{id}', 'GET', '893FEF97F0D1480BFBB327CF5003F431', 'N', '2019-02-26 18:12:57', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1100255551893315584', 'authhistoryresourcesv1', '[AuthHistory]管理', 'API', 'updateAuthHistory', '修改[AuthHistory]', 'SUPERADMIN', '/1/authHistory/{id}', 'PUT', '9BB2367E6E35CF19BE94C019F84B54C5', 'N', '2019-02-26 18:12:57', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1100255551935258624', 'authhistoryresourcesv1', '[AuthHistory]管理', 'API', 'getProfileById', '根据ID查询$[AuthHistory]简要信息', 'ALL', '/1/authHistory/{id}', 'GET', 'D9F843A4F95C4B7D361CCA580A04C737', 'N', '2019-02-26 18:12:57', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1100255551964618752', 'companyresourcesv1', '公司管理', 'API', 'createCompany', '创建公司', 'SUPERADMIN', '/1/company', 'POST', 'BB8BFCBFCD5B864CE3C3BB7FEFE33C58', 'N', '2019-02-26 12:46:29', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1100255551993978880', 'companyresourcesv1', '公司管理', 'API', 'deleteCompany', '删除公司', 'SUPERADMIN', '/1/company', 'DELETE', '9C231C503EE295ED86E9D470A363EFA0', 'N', '2019-02-26 12:46:29', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1100255552019144704', 'companyresourcesv1', '公司管理', 'API', 'getCompanyByPage', '后台分页获取$公司信息', 'SUPERADMIN', '/1/company/manage/page', 'GET', 'FC243FA11253BE092A2F6FCB352DB5DF', 'N', '2019-02-26 12:46:29', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1100255552044310528', 'companyresourcesv1', '公司管理', 'API', 'getCompanyById', '后台根据ID查询$公司', 'SUPERADMIN', '/1/company/manage/{id}', 'GET', '4CD3DAA056A83281D06EACAC1D926C17', 'N', '2019-02-26 12:46:29', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1100255552073670656', 'companyresourcesv1', '公司管理', 'API', 'updateCompany', '修改公司', 'SUPERADMIN', '/1/company/{id}', 'PUT', '7242420DAC23E21CA9A84F3A66271B8C', 'N', '2019-02-26 12:46:29', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1100255552098836480', 'machinemodelresourcesv1', '机型管理', 'API', 'deleteMachineModel', '删除机型', 'SUPERADMIN', '/1/machineModel', 'DELETE', 'BF36F96422A4BC0CFA3A154E68902A75', 'N', '2019-02-26 18:12:57', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1100255552119808000', 'machinemodelresourcesv1', '机型管理', 'API', 'createMachineModel', '创建机型', 'SUPERADMIN', '/1/machineModel', 'POST', '5DD534F8BF55770DF3A3461F9CDCC965', 'N', '2019-02-26 18:12:57', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1100255552144973824', 'machinemodelresourcesv1', '机型管理', 'API', 'getMachineModelByPage', '后台分页获取机型信息', 'SUPERADMIN', '/1/machineModel/page', 'GET', '4D58C8B91E9CFCD0D79A9051D962CC9D', 'N', '2019-02-26 18:12:57', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1100255552170139648', 'machinemodelresourcesv1', '机型管理', 'API', 'getMachineModelById', '后台根据编码查询机型', 'SUPERADMIN', '/1/machineModel', 'GET', 'EABA0FBE2DA2C807DA505BE558AB5DE3', 'N', '2019-02-26 18:12:57', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1100255552191111168', 'machinemodelresourcesv1', '机型管理', 'API', 'getProfileById', '根据ID查询$机型简要信息', 'ALL', '/1/machineModel/{id}', 'GET', '2376574B32569BF268826B314899A011', 'N', '2019-02-26 12:46:29', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1100255552216276992', 'machinemodelresourcesv1', '机型管理', 'API', 'updateMachineModel', '修改机型', 'SUPERADMIN', '/1/machineModel/{id}', 'PUT', 'F7DF72A995EA89AEF1DA06AB8A739A90', 'N', '2019-02-26 12:46:29', '0', 'A', 'N', null, null, null, null, null, null);
INSERT INTO `security_operation` VALUES ('1100309500067409920', 'deviceauthresourcesv1', '设备授权管理', 'API', 'doAuthDevice', '设备认证', 'ALL', '/1/deviceAuth', 'POST', '91A2B6F3C71F2D7F690B1829B5F89497', 'Y', '2019-02-26 18:12:57', '0', 'A', 'N', null, null, null, null, null, null);
...
-- ----------------------------
INSERT INTO `security_permission` VALUES ('1100211638566494208', 'SUPER_ADMIN', 'role', 'ADMIN', 'queryDict', 'dictionary', '2019-02-26 09:51:10', '9527', 'Y', null, null, null, null);
INSERT INTO `security_permission` VALUES ('1100211638570688512', 'SUPER_ADMIN', 'role', 'ADMIN', 'queryColumn', 'column', '2019-02-26 09:51:10', '9527', 'Y', null, null, null, null);
INSERT INTO `security_permission` VALUES ('1100211638570688513', 'SUPER_ADMIN', 'role', 'ADMIN', 'queryGroup', 'group', '2019-02-26 09:51:10', '9527', 'Y', null, null, null, null);
INSERT INTO `security_permission` VALUES ('1100211638570688514', 'SUPER_ADMIN', 'role', 'ADMIN', 'queryModules', 'sysmoudle', '2019-02-26 09:51:10', '9527', 'Y', null, null, null, null);
INSERT INTO `security_permission` VALUES ('1100211638570688515', 'SUPER_ADMIN', 'role', 'ADMIN', 'queryRole', 'role', '2019-02-26 09:51:10', '9527', 'Y', null, null, null, null);
INSERT INTO `security_permission` VALUES ('1100211638574882816', 'SUPER_ADMIN', 'role', 'ADMIN', 'addRole', 'role', '2019-02-26 09:51:10', '9527', 'Y', null, null, null, null);
INSERT INTO `security_permission` VALUES ('1100211638574882817', 'SUPER_ADMIN', 'role', 'ADMIN', 'queryPrivilege', 'privilege', '2019-02-26 09:51:10', '9527', 'Y', null, null, null, null);
INSERT INTO `security_permission` VALUES ('1100211638574882818', 'SUPER_ADMIN', 'role', 'ADMIN', 'queryDept', 'dept', '2019-02-26 09:51:10', '9527', 'Y', null, null, null, null);
INSERT INTO `security_permission` VALUES ('1100211638574882819', 'SUPER_ADMIN', 'role', 'ADMIN', 'queryUser', 'user', '2019-02-26 09:51:10', '9527', 'Y', null, null, null, null);
...
INSERT INTO `security_session` VALUES ('1100204803436421120', '0c231c0b-4c54-4c48-92c6-1670a1a6e5ca', 'SUPER_ADMIN', '1100204803214123008', '匿名用户', 'ANONYMOUS1100204803214123009', '0', 'Manage', '192.168.2.253', '2592000', 'N', '2019-02-26 09:24:01', 'request');
INSERT INTO `security_session` VALUES ('1100205097801064448', 'e343d3a6-41a4-414d-a4b6-deafcf2223d4', 'SUPER_ADMIN', '1100205097771704320', '匿名用户', 'ANONYMOUS1100205097771704321', '0', 'Manage', '192.168.2.253', '2592000', 'N', '2019-02-26 09:25:11', 'request');
INSERT INTO `security_session` VALUES ('1100207897629007872', '2b44a73c-b5f0-479a-aaae-02dcf9ff66de', 'SUPER_ADMIN', '1100207897587064832', '匿名用户', 'ANONYMOUS1100207897587064833', '0', 'Manage', '192.168.2.253', '2592000', 'N', '2019-02-26 09:36:18', 'request');
INSERT INTO `security_session` VALUES ('1100207897834528768', '59bc029b-0b4e-4416-bf56-1d6ea1b64c87', 'SUPER_ADMIN', '9527', '管理员', 'super', '300', 'Manage', '192.168.2.253', '2592000', 'N', '2019-02-26 09:36:18', 'Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/72.0.3626.109 Safari/537.36');
...
-- ----------------------------
INSERT INTO `systemctl_dictionary_entry` VALUES ('1100302298787123200', 'SUPER_ADMIN', 'machineModel', 'windows95', 'windows95', null, 'N', null, null, '2019-02-26 15:51:25', '9527', 'A', null, null, null, null);
INSERT INTO `systemctl_dictionary_entry` VALUES ('1100302429435498496', 'SUPER_ADMIN', 'machineModel', 'windows98', 'windows98', null, 'N', null, null, '2019-02-26 15:51:56', '9527', 'A', null, null, null, null);
INSERT INTO `systemctl_dictionary_entry` VALUES ('1100302474599763968', 'SUPER_ADMIN', 'machineModel', 'windows 7', 'windows 7', null, 'N', null, null, '2019-02-26 15:52:07', '9527', 'A', null, null, null, null);
INSERT INTO `systemctl_dictionary_entry` VALUES ('1100302573430149120', 'SUPER_ADMIN', 'machineModel', 'Linux 1', 'Linux 1', null, 'N', null, null, '2019-02-26 15:52:31', '9527', 'A', null, null, null, null);
INSERT INTO `systemctl_dictionary_entry` VALUES ('1100302682834374656', 'SUPER_ADMIN', 'machineModel', 'Android 7.1', 'Android 7.1', null, 'N', null, null, '2019-02-26 15:52:57', '9527', 'A', null, null, null, null);
