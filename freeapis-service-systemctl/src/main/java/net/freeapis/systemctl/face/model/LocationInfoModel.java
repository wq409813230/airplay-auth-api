 ...
 * 	地理位置
 *  Notes:
 *  $Id: LocationInfoVo.java 31101200-9 2014-10-14 16:43:51Z freeapis\freeapis $
 * 
 *  Revision History
 *  &lt;Date&gt;,			&lt;Who&gt;,			&lt;What&gt;
...
public class LocationInfoModel extends BaseModel {
	...
	public LocationInfoModel(LocationInfo po) {
		BeanUtils.copyProperties(po, this);

	}

	public LocationInfo LocationInfoVo2Po() {
		LocationInfo po = new LocationInfo();
