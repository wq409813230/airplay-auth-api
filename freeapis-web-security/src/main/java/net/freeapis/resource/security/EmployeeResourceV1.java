...
public class EmployeeResourceV1 extends BaseResources {
    ...
    @FreeapisOperation(name = "deleteEmployee", ApiLevel = APILevel.AGENCY, description = "刪除员工信息")
    @RequestMapping(value = "/{userId}", method = RequestMethod.DELETE)
    public ResponseModel<String> deleteEmployee(@PathVariable Long userId) throws Exception {
